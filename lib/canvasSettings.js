...
(function () {
  'use strict';
  var updateCanvasSettings = function () {
      ...
      <!-- <div class="color-settings">
        <div class="tab-container">
          ...
          <div class="tab-content" data-value="color-fill">
            <input id="color-picker1" value='black'/><br>
          </div>
    ...
    `)
      ...
      $(`XXXXtab-label`).click(function () {
        ...
        if (target === 'color-fill') {
          let color = $(`${_self.containerSelector} .toolpanel#background-panel .content #color-picker1`).val();
          try {
      ...
      $(`${this.containerSelector} .toolpanel#background-panel .content #color-picker1`).spectrum({
        flat: true,
        showPalette: false,
        showButtons: false,
        type: "color",
      ...
      if (0) {
        ...
        const gp = new Grapick({
          ...
          colorEl: '<input id="colorpicker1"/>' // I'll use this for the custom color picker
        });

        gp.setColorPicker(handler => {
          const el = handler.getEl().querySelector('#colorpicker1');
          $(el).spectrum({
            showPalette: false,
            showButtons: false,
            type: "color",
  ...
  window.ImageEditor.prototype.updateCanvasSettings = updateCanvasSettings;
})()