...
(function () {
  ...
  var freeDrawSettings = function () {
    ...
    $(`${this.containerSelector} .toolpanel#draw-panel .content`).append(`
      <div>
        ...
        <div class="input-container">
          ...
          <input id="color-picker2" value='black'/>
        </div>
      </div>
    `);
    ...
    $(`${this.containerSelector} .toolpanel#draw-panel .content #color-picker2`).spectrum({
      type: "color",
      showInput: "true",
      showInitial: "true",
      allowEmpty: "false",
    ...
    $(`${this.containerSelector} .toolpanel#draw-panel .content #color-picker2`).change(function () {
      try {
        color = $(this).val();
        updateBrush();
      } catch (_) {}
