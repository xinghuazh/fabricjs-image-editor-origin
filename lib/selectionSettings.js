  ...
  var selectionSettings = function () {
    ...
    $(`${this.containerSelector} .main-panel`).append(`
      <!-- <div class="toolpanel" id="select-panel">
        <div class="content"><p class="title">Selection Settings</p></div>
      </div> -->
      `);
    ...
    (() => {
      ...
      $(`#rect_width0`).change(function () {
        let x = parseFloat($('#rect_width0').val());
        _self.activeSelection.set("width", x);
        _self.canvas.renderAll(), _self.canvas.trigger('object:modified');
      })
    ...
    (() => {
      $(`${this.containerSelector} .toolpanel#select-panel .content`).append(`
        ...
        -->
      `);
      $(`#font_style0 button`).click(function () {
      ...
      $(`#font-sizes0 input`).change(function () {
      ...
      $(`#font-align0 #text-align`).change(function () {
        let mode = $(this).val();
    ...
    (() => {
      $(`${this.containerSelector} .toolpanel#select-panel .content`).append(`
        <!-- <div class="border-section">
          ...
          <div class="input-container"><label>Color</label><input id="color-picker" value="black1"></div>
    ...
    (() => {
      ...
      $(`#tool_position .align_button`).click(function () {
        let pos = $(this).data('align');
        console.log("pos:", pos);
